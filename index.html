...
<body>
  ...
  <script type="module">
    ...
    const firebaseConfig = {
      apiKey: "AIzaSyCCokhoAxN4UxT24UQpWQm89y0Ty96VJdc",
      authDomain: "sorpresa-para-ethan-9599f.firebaseapp.com",
      databaseURL: "https://sorpresa-para-ethan-9599f-default-rtdb.firebaseio.com/",
      projectId: "sorpresa-para-ethan-9599f",
      storageBucket: "sorpresa-para-ethan-9599f.firebasestorage.app",
      messagingSenderId: "556187940372",
      appId: "1:556187940372:web:494cb57834dc4e213cd901"
    };
    ...
    document.querySelectorAll(".date-option").forEach(btn => {
      btn.onclick = () => {
        ...
        set(ref(db, 'elecciones/novio/fecha'), btn.innerText);
      }
    });
    ...
    document.querySelectorAll(".food-option").forEach(btn => {
      btn.onclick = () => {
        ...
        // Guardar comida en Firebase
        set(ref(db, 'elecciones/novio/comida'), btn.innerText);
      }
    });
    ...
    document.querySelectorAll(".activity-option").forEach(btn => {
      btn.onclick = () => {
        ...
        set(ref(db, 'elecciones/novio/actividad'), btn.innerText);
      }
    });
